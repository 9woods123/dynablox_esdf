...
class Path {
 public:
  ...
  void updatePath(const std::vector<Node4D>& nodePath);
    /*!
       \brief Adds a segment to the path
       \param node a 4D node
    */
//================================================================================

  void addSegment(const Node4D& node);
  /*!
  ...
  */
  ...
  void addNode(const Node4D& node, int i);
    /*!
...
//================================================================================
  ...
  void addVehicle(const Node4D& node, int i);
  // ______________
  // PUBLISH METHODS
